...
L:RegisterTranslations("enUS", function() return {
	...
	--------------
    ["Gossip"] = true,
	["Automatically skip gossip text"] = true,
	["Enabled"] = true,
	...
	-- Gossip Text
	--------------
	["<Touch the unstable rift crystal.>"] = true, -- MC entrance
	["<Place my hand on the orb.>"] = true, -- BWL entrance
	["Thank you, Stable Master. Please take the animal."] = true, -- AV quest
	["With pleasure. These things stink!"] = true, -- AV quest
	["Trick or Treat!"] = true,
